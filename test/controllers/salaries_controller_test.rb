...
class SalariesControllerTest < ActionController::TestCase
  ...
  test "should create salary" do
    assert_difference('Salary.count') do
      post :create, salary: { bonus: @salary.bonus, grant_date: @salary.grant_date, price: @salary.price, user_id: @salary.user_id }
    end
  ...
  test "should update salary" do
    patch :update, id: @salary, salary: { bonus: @salary.bonus, grant_date: @salary.grant_date, price: @salary.price, user_id: @salary.user_id }
    assert_redirected_to salary_path(assigns(:salary))
  end
